...
@section("content")
    <section class="home_banner_area" id="home">
        <div class="banner_inner rgba-black-strong">
            <div class="container">
                <div class="banner_content">
                    <h2>heavy machinary company<br />best machines around</h2>
                    <p>If you are looking at blank cassettes on the web, you may be very confused at the difference in price. You may see some for as low as $.17 each.</p>
                    <a class="btn btn-lg text-white btn-outline-warning" href="#">Get Started</a>
                </div>
            </div>
        </div>
    </section>
